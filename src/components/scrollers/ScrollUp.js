...
const ScrollUp = () => {
	...
	return (
		<Wrapper onClick={scrollToTop} id="goTop" className={arrowVisible ? "btn-top show-arrow" : "btn-top hide-arrow"}>
			<svg className="arrow-up up" xmlns="http://www.w3.org/2000/svg"
				 viewBox="5 0 50 80" xmlSpace="preserve">
				<Arrow fill="none" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"
