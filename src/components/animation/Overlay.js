...
function Overlay({ loadAnimation }) {
  ...
  return (
    <motion.div
      ref={overlay}
      animate={animation.background.animate}
      initial={animation.background.initial}
    ...
    >
      <span className="element-overflow">
        <motion.div
          animate={animation.box.animate}
          initial={animation.box.initial}
          className="element-overflow-background"
        >
          {' '}
        </motion.div>
        ...
        <motion.img
          ...
          src={darkTheme.dark ? logoWhite : logo}
          alt="asrr"
        />
      </span>
    </motion.div>
