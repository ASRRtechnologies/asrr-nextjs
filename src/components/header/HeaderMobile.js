...
const Wrapper = styled('nav')`
        ...
        svg{
            path{
                fill: ${props => props.menuOpen ? props.theme.navigation.font : props.visible
	...
	: props.headerWhite ? 'white' : props.theme.navigation.font};
        ...
        p, a {
           color: ${props => props.menuOpen ? props.theme.navigation.font : props.visible
	? props.theme.navigation.font
	: props.headerWhite ? 'white' : props.theme.navigation.font};
        }
        ...
        .bar1, .bar2, .bar3, .chev > .line {
           background-color: ${props => props.menuOpen ? props.theme.navigation.font : props.visible
	? props.theme.navigation.font
	: props.headerWhite ? 'white' : props.theme.navigation.font};
        }
