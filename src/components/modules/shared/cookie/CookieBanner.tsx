...
function CookieBanner(props) {
  ...
  return (
    <CookieConsent
      ...
      buttonClasses={`${buttonStyles.button} ${buttonStyles.cookieButton} ${dark && buttonStyles.dark}`}
      buttonWrapperClasses={bannerStyles.buttonWrapper}
      buttonText="Accepteren">
      <div className="darkmodeContainer">
        <img src={dark ? cookies : cookiesDark} />
        ...
        <p>
          ...
          algemeen gebruik van de website. Door gebruik te maken van deze website gaat u hiermee akkoord.
          Meer info kunt u vinden in onze{" "}
          <span>
            <a className="hover-link link" href={privacy} target="_blank" rel="noopener noreferrer">
              privacybeleid.
            </a>
          </span>
        </p>
