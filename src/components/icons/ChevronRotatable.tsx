...
function ChevronRotatable(props: ChevronProps) {
  ...
  return (
    <>
      <Arrow onClick={props.onClick} rotated={props.rotate} version='1.1' id='Capa_1'
      ...
      >
        <g>
          <path fill={props.color || '#fff'} d='M225.923,354.706c-8.098,0-16.195-3.092-22.369-9.263L9.27,151.157c-12.359-12.359-12.359-32.397,0-44.751
